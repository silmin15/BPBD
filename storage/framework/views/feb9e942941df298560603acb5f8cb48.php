...
<body>
    ...
    <table class="meta">
        ...
        <tr>
            ...
            <td>Nama</td>
            <td>:</td>
            <td><?php echo e($bast->nama_perwakilan); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>Alamat/Desa</td>
            <td>:</td>
            <td><?php echo e($bast->desa); ?>, Kec. <?php echo e($bast->kecamatan); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>Jabatan</td>
    ...
    <table class="sign-table">
        <tr>
            <td>
                ...
                <div class="u"><?php echo e(strtoupper($bast->nama_perwakilan)); ?></div>
            </td>
            <td>
...
<?php /**PATH C:\laragon\www\BPBD\resources\views/role/pk/bast/pdf.blade.php ENDPATH**/ ?>